 ...
 */
class RxSchedulerExtension(var testScheduler: Scheduler = Schedulers.trampoline()) :
    AfterEachCallback, BeforeEachCallback {

    private val schedulerFunc: (Scheduler) -> Scheduler = { testScheduler }
    private val schedulerLazyFunc: (Callable<Scheduler>) -> Scheduler = { testScheduler }
